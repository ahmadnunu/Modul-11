...
<body>
    <div class="container m-5">
        ...
        <div class="list-group list-group-numbered mt-4">
            ...
            <a href="{{ url('/nuba') }}" class="list-group-item list-group-item-action">
                Nuba
            </a>
            ...
            <div class="list-group list-group-numbered mt-4"> <a href="{{ route('admin.dashboard') }}"
                    class="list-group-item list-group-item-action"> Admin Dashboard </a> <a
                    href="{{ route('admin.users') }}" class="list-group-item list-group-item-action"> Admin Users </a>
